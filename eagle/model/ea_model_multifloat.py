...
from .modeling_llama_kv_multifloat import LlamaForCausalLM as KVLlamaForCausalLM
...
from .cnets_multifloat import Model
...
class EaModel(nn.Module):
    ...
    def from_pretrained(
        ...
        print("BaseModel 8Floating Enabling")
        # print(base_model.dtype)
        # base_model = base_model.float()
        # low_model = deepcopy(base_model)
        highprec_model = base_model
        base_model = base_model.to(dtype=torch.float8_e4m3fn)
    ...
    def eagenerate(
        ...
        # prefill
        draft_tokens, retrieve_indices, tree_mask, tree_position_ids, logits, hidden_state, sample_token, tree_branch_sum = initialize_tree_w_float(
